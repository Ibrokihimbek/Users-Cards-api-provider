...
class UsersCardsSingleBlockPage extends StatelessWidget {
  const UsersCardsSingleBlockPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: BlocProvider(
        create: (context) =>
            SingleCardsBloc(appRepository: context.read<AppRepository>())
              ..add(FetchAllCardsSingleBloc()),
        child: BlocBuilder<SingleCardsBloc, SingleBlocCardsState>(
          builder: (context, state) {
            return Scaffold(
              ...
              body: state.cardsStatus == CardsStatus.LOADING
                  ? const Center(child: ShimmerWidget())
                  : state.cardsStatus == CardsStatus.SUCCESS
                      ? Center(
                          child: Expanded(
                      ...
                      : state.cardsStatus == CardsStatus.ERROR
                          ? Center(
                              child: Text(
